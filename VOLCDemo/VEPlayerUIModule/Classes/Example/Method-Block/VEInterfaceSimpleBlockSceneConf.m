...
- (VEInterfaceElementDescriptionImp *)playButton {
    return ({
        ...
        playBtnDes.elementDisplay = ^(VEActionButton *button) {
            [button setImage:[UIImage imageNamed:@"ve_longvideo_pause"] forState:UIControlStateNormal];
            [button setImage:[UIImage imageNamed:@"ve_longvideo_play"] forState:UIControlStateSelected];
        };
...
- (VEInterfaceElementDescriptionImp *)fullScreenButton {
    return ({
        ...
        fullScreenBtnDes.elementDisplay = ^(VEActionButton *button) {
            [button setImage:[UIImage imageNamed:@"ve_longvideo_fullscreen"] forState:UIControlStateNormal];
        };
...
- (VEInterfaceElementDescriptionImp *)backButton {
    return ({
        ...
        backBtnDes.elementDisplay = ^(VEActionButton *button) {
            [button setImage:[UIImage imageNamed:@"ve_longvideo_back"] forState:UIControlStateNormal];
        };
...
- (VEInterfaceElementDescriptionImp *)resolutionButton {
    return ({
        ...
        resolutionBtnDes.elementDisplay = ^(VEActionButton *button) {
            [button setImage:[UIImage imageNamed:@"ve_longvideo_resolution"] forState:UIControlStateNormal];
...
- (VEInterfaceElementDescriptionImp *)playSpeedButton {
    return ({
        ...
        playSpeedBtnDes.elementDisplay = ^(VEActionButton *button) {
            [button setImage:[UIImage imageNamed:@"ve_longvideo_playspeed"] forState:UIControlStateNormal];
...
- (VEInterfaceElementDescriptionImp *)moreButton {
    return ({
        ...
        moreButtonDes.elementDisplay = ^(VEActionButton *button) {
            [button setImage:[UIImage imageNamed:@"ve_longvideo_more"] forState:UIControlStateNormal];
        };
...
- (VEInterfaceElementDescriptionImp *)lockButton {
    return ({
        ...
        lockButtonDes.elementDisplay = ^(VEActionButton *button) {
            [button setImage:[UIImage imageNamed:@"ve_longvideo_unlock"] forState:UIControlStateNormal];
            [button setImage:[UIImage imageNamed:@"ve_longvideo_lock"] forState:UIControlStateSelected];
        };
...
- (VEInterfaceElementDescriptionImp *)loopPlayButton {
    return ({
        ...
        loopPlayButtonDes.elementDisplay = ^(VEInterfaceSlideMenuCell *cell) {
            ...
            cell.iconImgView.image = [UIImage imageNamed:@"ve_longvideo_loopplay"];
        };
